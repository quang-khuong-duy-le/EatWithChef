...
(function($){
    ...
    $.WebcamQRCode.defaultOptions = {
        ...
        webcamOnStart:		true,
        webcamStopContent:	$('<p>Đã dừng quét.</p>'),
        delay:				5000,
        path:				""
    };
    ...
    $.WebcamQRCode.start = function( $this ){
		...
		_flash.attr( 'data', __options.path + "/Content/frontend/jquery.webcamqrcode/swf/webcamqrcode.swf?ID=" + $this.attr( '_webcam_qrcode_id' ) );
